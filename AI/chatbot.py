...
def chatbot():
    ...
    while True:
        ...
        if user_input == 'bye':
            ...
            print(f"ChatBot: {random.choice(responses)}")
        elif "j23" in user_input:
            responses = [
                "We are from J23 industries provide the space technologies and automated robots",
                "We Provide automated services of robots ,,, and we are J23 INDUSTRIES "
            ]
            print(f"ChatBot : {random.choice(responses)}")
